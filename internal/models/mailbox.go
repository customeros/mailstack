...
type Mailbox struct {
	...
	// Authentication type (password, oauth, app_password, etc)
	AuthType string `gorm:"column:auth_type;type:varchar(50);not null" json:"authType"`
	...
	ImapSecurity string `gorm:"column:imap_security;type:varchar(50)" json:"imapSecurity"` // none, ssl, tls, starttls
	...
	SmtpSecurity string `gorm:"column:smtp_security;type:varchar(50)" json:"smtpSecurity"` // none, ssl, tls, starttls
