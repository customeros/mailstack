...
func (h *EmailsHandler) sendEmail(ctx context.Context, emailContainer *EmailContainer) (*smtp.SendResult, error) {
	...
	result := smtpClient.Send(ctx, emailContainer.Email, emailContainer.Attachments)
